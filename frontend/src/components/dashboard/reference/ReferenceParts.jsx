...
const KPI_ACCENT = {
  "total-orders": { iconBg: "bg-[var(--color-primary-soft)] text-[var(--color-primary)]", bar: "bg-[var(--color-primary)]" },
  ...
  "pending-approvals": { iconBg: "bg-[var(--color-primary-soft)] text-[var(--color-primary)]", bar: "bg-[var(--color-primary)]" },
  "good-qty": { iconBg: "bg-[#e8f8ef] text-[#15803d]", bar: "bg-[#15803d]" },
  "reject-qty": { iconBg: "bg-[#fde8e8] text-[#ef4444]", bar: "bg-[#ef4444]" },
  "inventory-value": { iconBg: "bg-[var(--color-primary-soft)] text-[var(--color-primary)]", bar: "bg-[var(--color-primary)]" },
  "low-stock": { iconBg: "bg-[#fde8e8] text-[#ef4444]", bar: "bg-[#ef4444]" },
  "raw-materials": { iconBg: "bg-[#e8f1ff] text-[#2563eb]", bar: "bg-[var(--color-primary)]" },
  "finished-goods": { iconBg: "bg-[#e8f8ef] text-[#15803d]", bar: "bg-[#15803d]" },
  warehouses: { iconBg: "bg-[var(--color-primary-soft)] text-[var(--color-primary)]", bar: "bg-[var(--color-primary)]" },
  "stock-movements": { iconBg: "bg-[#fff1e8] text-[#c2410c]", bar: "bg-[#c2410c]" },
  "total-users": { iconBg: "bg-[var(--color-primary-soft)] text-[var(--color-primary)]", bar: "bg-[var(--color-primary)]" },
  ...
  "total-sales-orders": { iconBg: "bg-[var(--color-primary-soft)] text-[var(--color-primary)]", bar: "bg-[var(--color-primary)]" },
  ...
  quotations: { iconBg: "bg-[var(--color-primary-soft)] text-[var(--color-primary)]", bar: "bg-[var(--color-primary)]" },
  "conversion-rate": { iconBg: "bg-[#e8f1ff] text-[#2563eb]", bar: "bg-[var(--color-primary)]" },
  "overdue-invoices": { iconBg: "bg-[#fde8e8] text-[#ef4444]", bar: "bg-[#ef4444]" },
  "total-production-orders": { iconBg: "bg-[var(--color-primary-soft)] text-[var(--color-primary)]", bar: "bg-[var(--color-primary)]" },
  ...
  "production-efficiency": { iconBg: "bg-[var(--color-primary-soft)] text-[var(--color-primary)]", bar: "bg-[var(--color-primary)]" },
  "machine-utilization": { iconBg: "bg-[#f3eefc] text-[#6d28d9]", bar: "bg-[#6d28d9]" },
  "total-inventory-items": { iconBg: "bg-[var(--color-primary-soft)] text-[var(--color-primary)]", bar: "bg-[var(--color-primary)]" },
  ...
  "pending-leave-requests": { iconBg: "bg-[var(--color-primary-soft)] text-[var(--color-primary)]", bar: "bg-[var(--color-primary)]" },
  "new-employees": { iconBg: "bg-[#e8f1ff] text-[#2563eb]", bar: "bg-[var(--color-primary)]" },
  ...
  "todays-revenue": { iconBg: "bg-[var(--color-primary-soft)] text-[var(--color-primary)]", bar: "bg-[var(--color-primary)]" },
  "pending-invoices": { iconBg: "bg-[var(--color-primary-soft)] text-[var(--color-primary)]", bar: "bg-[var(--color-primary)]" },
  ...
  "my-work-orders": { iconBg: "bg-[var(--color-primary-soft)] text-[var(--color-primary)]", bar: "bg-[var(--color-primary)]" },
  ...
  "assigned-machine": { iconBg: "bg-[var(--color-primary-soft)] text-[var(--color-primary)]", bar: "bg-[var(--color-primary)]" },
  "machine-status": { iconBg: "bg-[#e8f1ff] text-[#2563eb]", bar: "bg-[var(--color-primary)]" },
  "material-availability": { iconBg: "bg-[#e8f1ff] text-[#2563eb]", bar: "bg-[var(--color-primary)]" },

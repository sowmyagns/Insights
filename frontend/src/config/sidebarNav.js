...
export const SIDEBAR_NAV = [
  ...
  },
  {
    ...
    icon: Users,
    children: [
      { labelKey: "erpNav.hrDashboard", to: "/hr", module: "hr", end: true },
  ...
  {
    key: "attendance",
    labelKey: "erpNav.attendance",
    icon: CalendarDays,
    children: [
      { labelKey: "erpNav.attendanceDashboard", to: "/hr/attendance", module: "attendance", end: true },
      { label: "Daily Attendance", to: "/hr/attendance/daily", module: "attendance" },
      { labelKey: "erpNav.attendanceCalendar", to: "/hr/attendance/calendar", module: "attendance" },
      { labelKey: "erpNav.leaveSummary", to: "/hr/attendance/leave-summary", module: "attendance" },
      { labelKey: "erpNav.attendanceReports", to: "/hr/attendance/reports", module: "attendance" },
    ],
  },
  {
    key: "leaveManagement",
    labelKey: "erpNav.leaveManagement",
    icon: Palmtree,
    children: [
      { labelKey: "erpNav.leaveDashboard", to: "/hr/leave", module: "hr", end: true },
      { labelKey: "erpNav.applyLeave", to: "/hr/leave/create", module: "hr" },
      { labelKey: "erpNav.leaveCalendar", to: "/hr/leave", module: "hr" },
      { labelKey: "erpNav.leaveReports", to: "/hr/leave", module: "hr" },
    ],
  },
  {
    key: "hrPayroll",
    labelKey: "erpNav.payroll",
    icon: Wallet,
    children: [
      { labelKey: "erpNav.payrollDashboard", to: "/hr/payroll", module: "hr", end: true },
      { labelKey: "erpNav.runPayroll", to: "/hr/payroll/create", module: "hr" },
      { labelKey: "erpNav.payslips", to: "/hr/payroll", module: "hr" },
      { labelKey: "erpNav.payrollReports", to: "/hr/payroll", module: "hr" },
    ],
  },
  {
    key: "hrPerformance",
    labelKey: "erpNav.performance",
    icon: Users,
    children: [
      { labelKey: "erpNav.performanceDashboard", to: "/hr/performance", module: "hr", end: true },
      { labelKey: "erpNav.performanceReviews", to: "/hr/performance", module: "hr" },
      { labelKey: "erpNav.appraisals", to: "/hr/performance/create", module: "hr" },
    ],
  },
  {
    key: "recruitment",
    labelKey: "erpNav.recruitment",
    icon: UserPlus,
    children: [
      { labelKey: "erpNav.openPositions", to: "/hr/recruitment", module: "hr", end: true },
      { labelKey: "erpNav.candidates", to: "/hr/recruitment/candidates", module: "hr" },
      { labelKey: "erpNav.interviews", to: "/hr/recruitment/interviews", module: "hr" },
    ],
  },
  {
    key: "training",
    labelKey: "erpNav.training",
    icon: GraduationCap,
    children: [
      { labelKey: "erpNav.trainingPrograms", to: "/hr/training", module: "hr", end: true },
      { labelKey: "erpNav.trainingSessions", to: "/hr/training/sessions", module: "hr" },
    ],
  },
  {
    key: "hrReports",
    labelKey: "erpNav.hrReports",
    icon: BarChart3,
    children: [
      { labelKey: "erpNav.attendanceReports", to: "/hr/attendance/reports", module: "attendance" },
      { labelKey: "erpNav.payrollReports", to: "/hr/payroll", module: "hr" },
      { labelKey: "erpNav.leaveReports", to: "/hr/leave", module: "hr" },
      { labelKey: "erpNav.hrSummary", to: "/hr", module: "hr", end: true },
    ],
  },
  {
    key: "hrSettings",
    labelKey: "erpNav.hrSettings",
    icon: Settings,
    children: [
      { labelKey: "erpNav.hrSettings", to: "/hr/settings", module: "hr", end: true },

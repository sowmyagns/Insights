...
export const Recruitment = lazy(() => import("../pages/hr/Recruitment"));
export const Training = lazy(() => import("../pages/hr/Training"));
export const HRSettings = lazy(() => import("../pages/hr/HRSettings"));

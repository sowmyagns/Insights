  ...
  return (
    <div className="attendance-report">
      <div className="attendance-report-header">
        <h1 className="attendance-report-title">Site Visit Report</h1>
      ...
      <div className="leave-table-wrap">
        <table className="leave-table">
          ...
          <tbody>
            <tr>
              <td colSpan={8} className="leave-empty">Showing 0 to 0 of 0 entries</td>
            </tr>
          </tbody>
        </table>
      ...
      {showModal && (
        <Modal
          ...
          showClose
          title="Generate Site Visit Report"
        >
          ...
          <div className="attendance-report-body">
            ...
            <label className="leave-label">Visit Type</label>
            <select className="leave-input">
              <option>All Visit Type</option>
            </select>

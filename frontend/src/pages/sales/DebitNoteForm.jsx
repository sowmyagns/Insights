  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEdit) {
        ...
        addToast("Sales debit note updated");
      } else {
        ...
        addToast("Sales debit note created");
      }
      navigate("/sales/debit-notes");
    } catch (err) {
      console.error(err);
    ...
    >
      ...
      <div className="flex shrink-0 items-center justify-between gap-3 border-b border-[#e4e4ea] bg-white px-5 py-3.5">
        <div className="flex items-center gap-2">
          <button
            type="button"
            onClick={() => navigate("/sales/debit-notes")}

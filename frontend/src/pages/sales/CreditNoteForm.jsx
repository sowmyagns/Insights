...
export default function CreditNoteForm() {
  ...
  const [invoiceType, setInvoiceType] = useState("credit_note");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        document_type: invoiceType === "sales_return" ? "sales_return" : "credit_note",
    ...
    >
      ...
      <div className="min-h-0 flex-1 overflow-y-auto">
        <div className="mx-auto w-full max-w-[1200px] space-y-4 p-5 pb-10">
          {/* Top: note type + supplier — bordered two-column panel */}
          ...
          <section className="border-b border-[#d0d0d8] p-4 lg:border-b-0 lg:border-r">
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              ...
              <label className="block">
                <FieldLabel>Credit Note No.</FieldLabel>
                <SoftInput
              ...
              <div className="flex flex-col gap-2 p-3">
                ...
                >
                  {invoiceDiscount > 0
                    ...
                    : "+ Add Credit Note Level Discount"}
                </button>
              </div>
            </div>
          </div>
